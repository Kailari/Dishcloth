...
/**
 * <b>EventRegistrySingleton</b>
 * <p>
 * Internal singleton instance of EventRegistry
 * <p>
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *<br>
 * Created by ASDSausage on 6.8.2015 at 13:25
 */

final class EventRegistrySingleton implements IEventRegistry {

	private static EventRegistrySingleton instance;
	...
	private HashMap<Class, HashMap<Class, RegistryEntry>> eventRegistry = new HashMap<>();

	/**
	 * Contains list of EventHandler types contained in a listener class
	 */
	// <ListenerClass, List<EventClass>>
	private HashMap<Class, List<Class>> listenerRegistry = new HashMap<>();
	/**
	 * Classes that are already parsed for @EventHandlers
	 */
	private List<Class> registeredClasses = new ArrayList<>();

	private EventRegistrySingleton() {}

	protected static EventRegistrySingleton getInstance() {
		if (instance == null) {
			instance = new EventRegistrySingleton();
		}
	...
	@Override
	public void registerEventListenerInstance(Object object) {
		registerEventListener( object.getClass(), object );
	}

	@Override
	public void registerStaticEventListener(Class listenerClass) {
		registerEventListener( listenerClass, null );
	}

	private void registerEventListener(Class listenerClass, Object object) {
	...
	private void registerEventHandlers(Class listenerClass) {
		...
		Arrays.asList( listenerClass.getMethods() )
				...
				.forEach( method -> registerHandler( method, listenerClass ) );
	...
	private void registerHandler(Method method, Class listenerClass) {
	...
	@Override
	public boolean eventExists(Class eventClass) {
	...
	@Override
	public String parseEventNameFromClass(Class eventClass) {
	...
	private void fireEvent(IEvent event, Object instance, Method handler) {
		try {
